...
**Live app:** <https://uday-pesala-chieac-project-career-insights-dashboard.streamlit.app>
...
The app opens at [http://localhost:8501](http://localhost:8501). To pick a port: `streamlit run app.py --server.port 8631`.
...
2. Go to [https://share.streamlit.io](https://share.streamlit.io), sign in with GitHub and click **Create app → Deploy a public app from
  GitHub**.
